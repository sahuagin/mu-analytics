...
def build():
    return {
        ...
        "flagged_queue": [
            {"id": "mu·44a1", "fleet": "mu", "model": "claude-opus-4-8", "reason": "deg",
             "why": "stop_reason=degraded_eof mid-task", "conf": "Probable 0.62"},
            {"id": "mu·1d8e", "fleet": "mu", "model": "gpt-5.5", "reason": "err",
             "why": "exit_reason=error", "conf": "Probable 0.70"},
            {"id": "mu·be07", "fleet": "mu", "model": "claude-opus-4-7", "reason": "callout",
             "why": "self-flag: retry refused for bash", "conf": "Definite 0.88"},
        ],
        "compaction": {"mu": {"kept": 61, "dropped": 22, "summarized": 14, "failed": 1,
                              "before": 128400, "after": 41200, "events": 98},
                       "cc": {"kept": 0, "dropped": 0, "summarized": 0, "failed": 0,
                              "before": 0, "after": 0, "events": 0}},
        "context_trajectory": [8, 14, 22, 31, 44, 58, 73, 92, 118, 52, 64, 79, 96, 121, 148,
                               61, 74, 93, 116, 142, 171, 199, 88, 101, 124, 150],
        "context_compactions": [9, 15, 22],
        "tool_mix": [{"tool": "bash", "count": 1840}, {"tool": "read", "count": 1520},
                     {"tool": "edit", "count": 880}, {"tool": "grep", "count": 610},
                     {"tool": "write", "count": 420}, {"tool": "spawn_worker", "count": 96}],
        "recall": [{"source": "ProjectFile", "items": 188, "tokens": 96200},
                   {"source": "Memory", "items": 412, "tokens": 38400},
                   {"source": "Bootloader", "items": 34, "tokens": 12100}],
        "cache_econ": {"median_gap_min": 0.2, "p90_gap_min": 6.4, "save_pct": 1.0,
                       "save_pct_p90": 54.0, "w5_tokens": 120000, "w1_tokens": 5800000,
                       "read_tokens": 120000000},
        "per_ask": [{"i": i + 1, "cost": round(0.41 if i % 7 == 0 else 0.034 + (i % 5) * 0.004, 3),
                     "rewrite_5m": i % 7 == 0} for i in range(28)],
        "stop_reason_health": [{"stop_reason": "end_turn", "count": 4492},
                               {"stop_reason": "iteration_cap", "count": 66},
                               {"stop_reason": "max_tokens", "count": 50}],
        "meta": {"enrichment_status": "pending_commit_enricher", "duckdb": True,
                 "event_dir_present": True, "marks_n": 5,
                 "flags": {"overview": {"thin": False},
